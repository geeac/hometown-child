...
<div class="carousel-wrap">
	<div class="lt-carousel lt-carousel-single property-carousel property-carousel-<?php echo $uid; ?>" data-items="1" data-dots="false"  data-auto-height="true"  data-single-item="true" data-autoplay="<?php echo $property_slide_autoplay; ?>" data-autoplay-timeout="<?php echo $property_slide_timeout; ?>" data-autoplay-hover-pause="true" data-nav="true" data-loop="false" data-nav-thumb=".property-thumb-nav-<?php echo $uid; ?>">
...
<ul class="meta-box-list">
	...
	<?php
		if(get_field('hoffman_label_bathroom')) { echo '<li>' . get_field('hoffman_label_bathroom') . '</li>'; }
		if(get_field('hoffman_label_bedroom')) { echo '<li>' . get_field('hoffman_label_bedroom') . '</li>'; }
		if(get_field('hoffman_label_garage')) { echo '<li>' . get_field('hoffman_label_garage') . '</li>'; }
		if(get_field('hoffman_label_area')) { echo '<li>' . get_field('hoffman_label_area') . '</li>'; }
	?>
</ul>
