<?php
	...
	if(is_singular('agent')) {
		...
		if(get_post_meta( $post_id, '_meta_email', true )) $sub_title .= '<li><a href="mailto:'.get_post_meta( $post_id, '_meta_email', true ).'">'.get_post_meta( $post_id, '_meta_email', true ).'</a></li>';
	...
	if(is_page_template('template-member.php')) {
		...
		if($current_user->user_email) $sub_title .= '<li><a href="mailto:'.$current_user->user_email.'">'.$current_user->user_email.'</a></li>';
	...
	if(is_singular('property')) {
		$sub_title = '<ul>';
		$sub_title .= get_the_term_list($post->ID, 'location', '<li>', '</li><li>', '</li>');
		$sub_title .= get_the_term_list($post->ID, 'type', '<li>', '</li><li>', '</li>');
		$sub_title .= '</ul>';

		$big_subtitle = get_post_meta( $post->ID, 'subtitle', true );
	}
